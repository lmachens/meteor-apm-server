describe('alerts', function() {
  ...
  it('user can create an app and route to alerts tab', function() {
    ...
    var expectedPath = '/apps/' + app._id + '/dashboard/overview?action=alerts';
  ...
  it('create new alert with filling some mandatory fields', function() {
    ...
    var app = getApp('first-app');
    var expectedPath = '/apps/' + app._id + '/dashboard/overview?action=alerts&mode=list';
    var newPath = GlobalClient.getCurrentPath();
    expect(newPath).to.be.equal(expectedPath);
  });

  it("user can vist editor by clicking 'Create New' on alerts tab list page", function() {
    createFirstApp();
    var app = getApp('first-app');
    ...
    var expectedPath = '/apps/' + app._id + '/dashboard/overview?action=alerts&mode=create';
    var newPath = GlobalClient.getCurrentPath();
    expect(newPath).to.be.equal(expectedPath);
  });
});
