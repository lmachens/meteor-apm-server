describe('apps', function() {
  ...
  it('user submit an appname, got the error, then submit the correct one', function() {
  ...
  it('user should be able to visit the app page by clicking applist arrow Icon', function() {
    createFirstApp();
    var app = getApp('first-app');
    var appId = app._id;
