...
KadiraData.defineTraces(
  ...
  'pubTraces',
  function(args) {
    KadiraDataHelpers.removeExpireFlag('pubTraces', args.query.appId, args.query._id);
...
KadiraData.defineTraces(
  'traces.methodsSingle',
  'methodTraces',
  function(args) {
    KadiraDataHelpers.removeExpireFlag('methodTraces', args.query.appId, args.query._id);
...
KadiraData.defineTraces(
  ...
  'errorTraces',
  function(args) {
    KadiraDataHelpers.removeExpireFlag('errorTraces', args.query.appId, args.query._id);
...
KadiraData.defineTraces(
  ...
  [KadiraDataFilters.convertObjectToId, KadiraDataFilters.limitSamples(5)]
);
...
KadiraData.defineTraces('traces.traceSample', 'errorTraces', function(args) {
  ...
  if (args.realtime) {
    query.startTime = KadiraData._CalulateRealtimeDateRange(resolution, range);
  } else {
    query.startTime = KadiraData._CalculateDateRange(args.time, range);
  }
