KadiraData.defineMetrics(
  ...
  [KadiraDataFilters.roundTo(['memory'], 2), KadiraDataFilters.addZeros(['memory'])]
);
...
KadiraData.defineMetrics(
  ...
  [KadiraDataFilters.toPct(2), KadiraDataFilters.addZeros(['pcpu'])]
);
...
KadiraData.defineMetrics(
  ...
  [KadiraDataFilters.roundTo(['resTime'], 2), KadiraDataFilters.addZeros(['resTime'])]
);
...
KadiraData.defineMetrics(
  ...
  [KadiraDataFilters.roundTo(['sessions'], 0), KadiraDataFilters.addZeros(['sessions'])]
);
