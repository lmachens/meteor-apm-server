...
(function() {
      ...
      return {
        ...
        brighten: function(a) {
          if (d)
            ...
            var c;
            for (c = 0; c < 3; c++)
              (b[c] += F(a * 255)), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255);
          }
          return this;
        },
        rgba: b,
  ...
  P.prototype = {
    ...
    updateShadows: function(a, b) {
      for (var c = this.shadows, d = c.length; d--; )
        c[d].setAttribute(
          a,
          a === 'height' ? t(b - (c[d].cutHeight || 0), 0) : a === 'd' ? this.d : b
        );
    },
    addClass: function(a) {
      var b = this.element,
    ...
    css: function(a) {
      ...
      if (e) {
        e = this.textWidth =
          (a && a.width && d.nodeName.toLowerCase() === 'text' && F(a.width)) || this.textWidth;
        b && (a = r(b, c));
        this.styles = a;
      ...
      $a && a === 'click'
        ? ((d.ontouchstart = function(a) {
          ...
          (d.onclick = function(a) {
            (za.indexOf('Android') === -1 || ya.now() - (c.touchEventFired || 0) > 1100) &&
              b.call(d, a);
          }))
        : (d['on' + a] = b);
      return this;
    ...
    zIndexSetter: function(a, b) {
      ...
      if (e) {
        ...
        for (i = 0; i < d.length && !h; i++)
          if (((e = d[i]), (f = J(e, 'zIndex')), e !== g && (F(f) > a || (!s(a) && s(f)))))
  ...
  ua.prototype = {
            ...
            o(g, function(e) {
              if (e !== '' || g.length === 1) {
                var n = {},
                  ...
                  p;
                h.test(e) &&
                  ((p = e.match(h)[1].replace(/(;| |^)color([ :])/, '$1fill$2')), J(x, 'style', p));
                i.test(e) &&
                  !d &&
                  ...
                  if (m) {
                    for (
                      var n = e.replace(/([^\^])-/g, '$1- ').split(' '),
                        o = g.length > 1 || f || (n.length > 1 && k.whiteSpace !== 'nowrap'),
                        T,
                        y,
                        s,
                        t = [],
                      ...
                      (a.rotation = 0),
                        ...
                        q && y
                          ? ((A /= 2),
                            z === '' || (!T && A < 0.5)
                              ? (n = [])
                              : (T && (y = !0),
                                (z = e.substring(0, z.length + (T ? -1 : 1) * sa(A))),
                                (n = [z + (m > 3 ? '\u2026' : '')]),
                        ...
                        n.length &&
                          x.appendChild(C.createTextNode(n.join(' ').replace(/- /g, '-')));
    ...
    button: function(a, b, c, d, e, f, g, h, i) {
      ...
      j.setState = function(a) {
        (j.state = k = a)
          ? a === 2 ? j.attr(g).css(x) : a === 3 && j.attr(h).css(p)
          : j.attr(e).css(n);
      };
      return j
        .on('click', function(a) {
    ...
    fontMetrics: function(a, b) {
      ...
      b &&
        K.getComputedStyle &&
        ((b = b.element || b), (a = (c = K.getComputedStyle(b, '')) && c.fontSize));
  ...
  r(P.prototype, {
    ...
    setSpanRotation: function(a, b, c) {
      var d = {},
        e = xa
          ? '-ms-transform'
          : fb ? '-webkit-transform' : Ja ? 'MozTransform' : Ib ? '-o-transform' : '';
    ...
    D = {
      ...
      fillSetter: function(a, b, c) {
        ...
        if (d === 'SPAN') c.style.color = a;
          ...
          (c.filled = a !== O), this.setAttr('fillcolor', this.renderer.color(a, c, b, this));
      },
      opacitySetter: ta,
  ...
  Ra.prototype = {
    ...
    handleOverflow: function(a) {
      ...
      if (h)
        ...
        ((d = c + (1 - i) * j),
        c - i * j < f ? (k = a.x + k * (1 - i) - f) : d > e && ((k = e - a.x + k * i), (m = -1)),
        (k = z(b.slotWidth, k)),
        k < b.slotWidth &&
          b.labelAlign === 'center' &&
      ...
      if (i && !isNaN(z))
        (i.xy = r = this.getLabelPosition(z, r, i, g, k, w, a, t)),
          ...
          (this.isLast && !this.isFirst && !p(e.showLastLabel, 1))
            ? (s = !1)
            : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r),
          t && a % t && (s = !1),
          s && !isNaN(r.y)
            ? ((r.opacity = c), i[this.isNew ? 'attr' : 'animate'](r), (this.isNew = !1))
            : i.attr('y', -9999);
    },
    destroy: function() {
      Oa(this, this.axis);
  ...
  B.PlotLineOrBand.prototype = {
    render: function() {
      ...
      if (g) {
        if (((n = b.getPlotLinePath(k, g)), (u = { stroke: x, 'stroke-width': g }), m))
          u.dashstyle = m;
      } else if (j) {
  ...
  ha.prototype = {
      ...
      o(a.series, function(c) {
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            ...
            c = c.dataMin;
            if (s(c) && s(e))
              (a.dataMin = z(p(a.dataMin, c), c)), (a.dataMax = t(p(a.dataMax, e), e));
            if (s(d))
    ...
    setTickInterval: function(a) {
      ...
      if (b.range && s(b.max))
        (b.userMin = b.min = t(b.min, b.minFromRange())), (b.userMax = b.max), (b.range = null);
    ...
    unsquish: function() {
      ...
      c
        ? (m = s(h)
            ? [h]
            : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) &&
          o(m, function(a) {
            var b;
            if (a === h || (a && a >= -90 && a <= 90))
              (j = l(N(i.h / aa(ga * a)))),
    ...
    renderUnsquish: function() {
      var a = this.chart,
        ...
        i = (this.slotWidth =
          (f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / h) ||
      ...
      if (this.autoRotation)
        ...
        for (i = c.length; !f && i--; )
          if (((j = c[i]), (j = d[j].label)))
            if (
              (j.styles.textOverflow === 'ellipsis' && j.css({ textOverflow: 'clip' }),
      ...
      if (
        k.rotation &&
        ((m = { width: (l > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + 'px' }),
        !h)
      )
      ...
      o(c, function(a) {
        var b = (a = d[a]) && a.label;
        if (b) m && b.css(A(m, b.specCss)), delete b.specCss, b.attr(k), (a.rotation = k.rotation);
      });
          ...
          o(g, function(b, c) {
            if (c % 2 === 0 && b < a.max)
              k[b] || (k[b] = new B.PlotLineOrBand(a)),
                ...
                (k[b].options = { from: e ? ia(y) : y, to: e ? ia(t) : t, color: l }),
                k[b].render(),
                (k[b].isActive = !0);
          });
        if (!a._addedPlotLB)
  ...
  Mb.prototype = {
    ...
    getAnchor: function(a, b) {
      ...
      c ||
        ...
        (c = [
          e ? d.plotWidth - i : h,
          this.shared && !e && a.length > 1 && b ? b.chartY - f : e ? d.plotHeight - h : i
        ]));
      return Ta(c, w);
    },
  ...
  Ua.prototype = {
    ...
    runPointActions: function(a) {
      var b = this.chart,
        ...
        n;
      if (!e && !g)
        for (h = 0; h < c.length; h++) if (c[h].directTouch || !c[h].options.stickyTracking) c = [];
      !e && g && g.directTouch && f
        ? (l = f)
        : (o(c, function(b) {
    ...
    reset: function(a, b) {
      ...
      if (a)
        ...
        if (this._onDocumentMouseMove)
          Z(C, 'mousemove', this._onDocumentMouseMove), (this._onDocumentMouseMove = null);
        o(c.axes, function(a) {
          a.hideCrosshair();
        });
    ...
    drag: function(a) {
      ...
      if (!l || !l.touch)
        if (
          (d < h ? (d = h) : d > h + j && (d = h + j),
          e < i ? (e = i) : e > i + k && (e = i + k),
          (this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(q - e, 2))),
          this.hasDragged > 10)
        ) {
          m = b.isInsidePlot(n - h, q - i);
          if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !x && !l)
  ...
  r(B.Pointer.prototype, {
    ...
    pinch: function(a) {
      var b = this,
        ...
        k =
          f === 1 &&
          ((b.inClass(a.target, 'highcharts-tracker') && c.runTrackerClick) || b.runChartClick),
        m = {};
  ...
  if (K.PointerEvent || K.MSPointerEvent) {
    var va = {},
      ...
      Bb = function(a, b, c, d) {
        a = a.originalEvent || a;
        if ((a.pointerType === 'touch' || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && Y[oa])
          d(a),
            (d = Y[oa].pointer),
            d[b]({ type: c, target: a.currentTarget, preventDefault: ta, touches: Wb() });
      };
    r(Ua.prototype, {
  ...
  lb.prototype = {
    ...
    renderItem: function(a) {
      ...
      if (e && this.itemX - x + f > (l || b.chartWidth - 2 * j - x - d.x))
        (this.itemX = x), (this.itemY += q + this.lastLineHeight + n), (this.lastLineHeight = 0);
      ...
      if (m || l) {
        if (i) {
          ...
          (a.box = i = c
            ...
            .attr({ stroke: j.borderColor, 'stroke-width': m || 0, fill: l || O })
            .add(d)
            .shadow(j.shadow)),
            (i.isNew = !0);
        i[f ? 'show' : 'hide']();
    ...
    handleOverflow: function(a) {
      ...
      if (a > f) {
        ...
        r(c.chartHeight), l.hide(), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0);
      return a;
    },
    scroll: function(a, b) {
      var c = this.pages,
  ...
  D.prototype = {
    ...
    layOutTitles: function(a) {
      ...
      if (
        ...
        (c
          ...
          .align(r({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f), !1, 'spacingBox'),
      ...
      d &&
        (d
          ...
          .align(
            r({ y: b + (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b }, e),
            !1,
            'spacingBox'
          ),
    ...
    drawChartBox: function() {
      ...
      if (l)
        g
          ? g.animate(g.crisp({ x: q, y: p, width: o, height: t, strokeWidth: -l }))
          : (this.plotBorder = b
              .rect(q, p, o, t, 0, -l)
              .attr({ stroke: a.plotBorderColor, 'stroke-width': l, fill: O, zIndex: 1 })
              .add());
      this.isDirtyBox = !1;
    },
    ...
    isReadyToRender: function() {
      var a = this;
      return (!ca && K == K.top && C.readyState !== 'complete') || (fa && !K.canvg)
        ? (fa
            ? Lb.push(function() {
                a.firstRender();
      ...
      getCenter: function() {
        ...
        for (g = 0; g < 4; ++g)
          (h = e[g]),
            (a = g < 2 || (g === 2 && /%$/.test(h))),
            (e[g] =
              (/%$/.test(h) ? [d, b, f, e[2]][g] * parseFloat(h) / 100 : parseFloat(h)) +
              (a ? c : 0));
        return e;
      }
    }),
  ...
  R.prototype = {
    ...
    getCyclic: function(a, b, c) {
      var d = this.userOptions,
        ...
        f = a + 'Counter';
      b ||
        (s(d[e]) ? (b = d[e]) : ((d[e] = b = this.chart[f] % c.length), (this.chart[f] += 1)),
        (b = c[b]));
      this[a] = b;
    },
    getColor: function() {
      ...
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
        ...
        if (n && h > n) {
          ...
          if (qa(k)) {
            ...
            if (t) for (c = 0; c < h; c++) (i = a[c]), (q[c] = i[0]), (x[c] = i.slice(1, t + 1));
            else for (c = 0; c < h; c++) (i = a[c]), (q[c] = i[0]), (x[c] = i[1]);
          else la(12);
        } else
          for (c = 0; c < h; c++)
            if (
      ...
      for (l = 0; l < g; l++)
        (i = h + l),
          j
            ...
            : (b[i] ? (k = b[i]) : a[i] !== v && (b[i] = k = new f().init(this, a[i], d[l])),
              (m[l] = k)),
          (m[l].index = i);
      if (b && (g !== (c = b.length) || j))
        for (l = 0; l < c; l++)
          if ((l === h && !j && (l += g), b[l])) b[l].destroyElements(), (b[l].plotX = v);
      this.data = b;
      this.points = m;
    },
    ...
    translate: function() {
      ...
      for (
        ...
        r.plotY = n =
          typeof u === 'number' && u !== Infinity ? z(t(-1e5, e.translate(u, 0, 1, 0, 1)), 1e5) : v;
    ...
    setClip: function(a) {
      var b = this.chart,
        ...
        f = e || b.clipBox,
        g =
          this.sharedClipKey || ['_sharedClip', a && a.duration, a && a.easing, f.height].join(','),
        h = b[g],
        i = b[g + 'm'];
      if (!h) {
        if (a)
    ...
    if (
      ...
      for (s = 0; s < d; s++) {
        ...
        e === 'percent'
          ? ((q = q ? i : j),
            k && l[q] && l[q][u]
              ? ((q = l[q][u]), (o.total = q.total = t(q.total, o.total) + N(y) || 0))
  ...
  wa = ka(R, {
    ...
    getColumnMetrics: function() {
      ...
      return (a.columnMetrics = {
        ...
        offset:
          (m - b) / 2 +
          (k + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * m - j / 2) * (e ? -1 : 1)
      });
    },
    translate: function() {
      var a = this,
        ...
        o(e, function(e) {
          ...
          if (n && !h) e.dataLabel = n.destroy();
            ...
            if (n)
              ...
              n = e.dataLabel = k[h ? 'text' : 'label'](i, 0, -999, d.shape, null, null, d.useHTML)
                .attr(n)
                .css(r(u, y))
                .add(j)
                .shadow(d.shadow);
  ...
  R.prototype.alignDataLabel = function(a, b, c, d, e) {
    ...
    if (m)
      (d = r(
        { x: g ? f.plotWidth - i : h, y: w(g ? f.plotHeight - h : i), width: 0, height: 0 },
        d
      )),
        ...
        c.rotation
          ...
          : (b.align(c, null, d),
            ...
            p(c.overflow, 'justify') === 'justify'
              ...
              : p(c.crop, !0) &&
                (m = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)),
                ...
                if ((v = b.dataLabel) && v._pos && b.visible)
                  (D = v._attr.visibility),
                    ...
                    (k = m
                      ...
                      : ['M', A + (y[6] === 'left' ? 5 : -5), B, 'L', y[2], y[3], 'L', y[4], y[5]]),
                    j
  ...
  U = B.TrackerMixin = {
    ...
    drawTrackerGraph: function() {
      ...
      for (l = 0; l < k.length; l++)
        (e = k[l]), d.push('M', e.plotX - i, e.plotY, 'L', e.plotX + i, e.plotY);
      j
        ? j.attr({ d: d })
        : ((a.tracker = h
            .path(d)
    ...
    pan: function(a, b) {
      ...
      o(b === 'xy' ? [1, 0] : [1], function(b) {
        var d = a[b ? 'chartX' : 'chartY'],
          ...
          i = i > d;
        if (h.series.length && (i || m > z(k.dataMin, k.min)) && (!i || j < t(k.dataMax, k.max)))
      ...
      if (
        ...
        if (this.graphic)
          (g = g && this.graphic.symbolName && o.r),
            this.graphic.attr(A(o, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})),
            k && k.hide();
        else {
          if (a && i)
            if (
              ...
              (e.stateMarkerGraphic = k = l.renderer
                .symbol(m, c - g, d - g, 2 * g, 2 * g)
                .attr(o)
                .add(e.markerGroup)),
                (k.currentSymbol = m);
          if (k)
            k[a && l.isInsidePlot(c, d, l.inverted) ? 'show' : 'hide'](), (k.element.point = this);
        }
