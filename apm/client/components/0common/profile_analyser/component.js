  ...
  this.onRendered(function() {
    this.autorun(function() {
      ...
      if (profile) {
        ...
        var metric = FlowRouter.getQueryParam('metric') || this.sortOptions[0].value;
...
component.prototype.loadHbarData = function(profile, sortedValueType) {
  ...
  if (sortedValueType === 'costlyFunction') {
    if (this.costlyFunctionMethodsData) {
      ...
      methodsData = this.getDataArr(profile.sortedFunctions, totalHitCount, 'callUID');
    ...
    if (this.overviewMethodsData) {
      ...
      methodsData = this.getDataArr(profile.sortedOverviews, totalHitCount, null, 'name');
...
component.prototype.getDataArr = function(sortedData, totalHitCount, idAttr, titleAttr) {
...
component.prototype.renderFlameGraphOverview = function(profile, selectedOverview) {
  if (selectedOverview) {
...
component.prototype.getPathsArr = function(profile, selectedFunction) {
  ...
  pathsArr = _.sortBy(pathsArr, function(item) {
    return 1 / item.pValue;
  });
  return pathsArr;
};
