...
var Formatters = {
  ...
  'ddp-updated': function(info) {
    ...
    return (
      color('Receive', '#28ACDF') + ' DDP <em>updated</em> message for methods: ' + methodNames
    );
  },
...
Template['kadiraDebug.eventItem'].helpers({
  ...
  // trace dialog apears
  id: function() {
    var id = generateUniqueId(this.baseTimestamp + this.type + JSON.stringify(this.info));
    return id;
  }
});
