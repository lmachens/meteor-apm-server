...
if (Meteor.isClient) {
  var cioClientConfig = Meteor.settings && Meteor.settings.public && Meteor.settings.public.cio;
  ...
  Deps.autorun(function() {
    ...
    if (user) {
      ...
      if (user.createdAt) {
        ...
        properties.daysAfterRegister = Math.ceil(millisAfterRegister / (1000 * 3600 * 24));
      }
