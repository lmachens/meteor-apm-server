...
!(function($) {
  ...
  var Datetimepicker = function(element, options) {
    ...
    this.pickerPosition =
      options.pickerPosition || this.element.data('picker-position') || 'bottom-right';
    ...
    this.setDaysOfWeekDisabled(
      options.daysOfWeekDisabled || this.element.data('date-days-of-week-disabled')
    );
    this.fillDow();
    this.fillMonths();
    this.update();
    ...
    fill: function() {
      ...
      for (var i = 0; i < 60; i += this.minuteStep) {
        ...
        if (this.showMeridian && dates[this.language].meridiem.length == 2) {
          ...
          html.push(
            '<span class="minute' + clsName + '">' + txt + ':' + (i < 10 ? '0' + i : i) + '</span>'
          );
          if (i == 59) {
            html.push('</fieldset>');
          }
