KadiraData.defineMetrics(
  ...
  function(args) {
    ...
    projectDef.resTime = KadiraDataHelpers.divideWithZero('$resTime', '$subs', true);
...
KadiraData.defineMetrics(
  ...
  function(args) {
    ...
    projectDef.observerReuse = KadiraDataHelpers.safeMultiply(
      KadiraDataHelpers.divideWithZero('$cachedObservers', '$totalObserverHandlers', true),
      100
    );
  ...
  [
    ...
    KadiraDataFilters.roundTo(['resTime', 'lifeTime', 'polledDocuments', 'changedDocuments'], 0)
  ]
);
...
KadiraData.defineMetrics(
  ...
  function(args) {
    ...
    projectDef.methodResTime = KadiraDataHelpers.divideWithZero('$methodResTime', '$count', true);
...
KadiraData.defineMetrics(
  ...
  [KadiraDataFilters.roundTo(['memory', 'pcpu'], 2), KadiraDataFilters.roundTo(['sessions'], 0)]
);
